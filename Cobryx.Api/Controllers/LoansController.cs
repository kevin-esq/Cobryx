...
public class LoansController : CobryxBaseController
{
        ...
        [FromHeader(Name = "Idempotency-Key")] string? idempotencyKey = null)
    {
        ...
        return HandleCreatedResult($"/api/lending/loans/{result.Value}/schedule", result, LendingApiOutcomes.LoanCreated);
    }
    ...
    public async Task<IActionResult> GetSchedule(Guid id)
    {
        ...
        var mapped = new AmortizationScheduleContract(
            ...
            result.Value.Installments.Select(i => new InstallmentContract(
                i.Id,
                i.InstallmentNumber,
                i.DueDate,
                i.PrincipalAmount,
        ...
        [FromHeader(Name = "Idempotency-Key")] string? idempotencyKey = null)
    {
        ...
        var result = await Sender.Send(command);
        return HandleCreatedResult($"/api/lending/loans/{id}/payments/{result.Value}", result, LendingApiOutcomes.PaymentRegistered);
    }
