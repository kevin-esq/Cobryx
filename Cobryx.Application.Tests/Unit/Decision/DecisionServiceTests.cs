...
namespace Cobryx.Application.Tests.Unit.Decision;
...
public class DecisionServiceTests
{
    ...
    public async Task ShouldCacheDecision()
    {
        ...
        macroStoreMock.Setup(x => x.GetAsync()).ReturnsAsync(new MacroState { InterestRate = 0.05m, Inflation = 0.02m });
        ...
        var service = new DecisionService(
            ...
            new Mock<IPortfolioEngine>().Object, portfolioStoreMock.Object,
            macroStoreMock.Object,
