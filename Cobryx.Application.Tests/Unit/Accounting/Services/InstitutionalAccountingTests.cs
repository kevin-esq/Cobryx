...
public class InstitutionalAccountingTests
{
    ...
    public async Task LedgerIntegrity_ShouldSupportIncrementalReplay_AndIgnoreHistoricalCorruption()
    {
        ...
        {
            var service = new LedgerIntegrityService(context1, new CobryxMetrics(), _clockMock.Object, Mock.Of<ILogger<LedgerIntegrityService>>());
        ...
        {
            var service = new LedgerIntegrityService(context3, new CobryxMetrics(), _clockMock.Object, Mock.Of<ILogger<LedgerIntegrityService>>());
        ...
        {
            var service = new LedgerIntegrityService(context4, new CobryxMetrics(), _clockMock.Object, Mock.Of<ILogger<LedgerIntegrityService>>());
