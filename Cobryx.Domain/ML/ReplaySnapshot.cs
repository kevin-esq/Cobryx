...
/// <summary>
/// Snapshot for ML model replay and comparison.
/// </summary>
public class ReplaySnapshot
{
    ...
    public string MacroStateJson { get; set; } = string.Empty;
    public string PortfolioStateJson { get; set; } = string.Empty;
    public string DecisionContextJson { get; set; } = string.Empty;
    public string ExecutionTraceJson { get; set; } = string.Empty;
    ...
    public string ReplayModelVersion { get; set; } = string.Empty;
