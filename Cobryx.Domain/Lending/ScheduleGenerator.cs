...
public class ScheduleGenerator : IScheduleGenerator
{
    ...
    private static decimal GetPeriodicRate(decimal annualRate, PaymentFrequency frequency)
    {
    ...
    private static decimal DecimalPower(decimal x, int n)
    {
        decimal result = 1;
        for (int i = 0; i < n; i++)
        {
    ...
    private static DateTime GetNextDueDate(DateTime date, PaymentFrequency frequency)
    {
        return frequency switch
        {
