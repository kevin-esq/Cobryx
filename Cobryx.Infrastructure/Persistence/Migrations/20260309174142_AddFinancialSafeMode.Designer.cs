...
namespace Cobryx.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260309174142_AddFinancialSafeMode")]
    partial class AddFinancialSafeMode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cobryx.Domain.Entities.Accounting.AccountBalanceSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Cobryx.Domain.Entities.Accounting.BankMovement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Cobryx.Domain.Entities.Accounting.JournalCheckpoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Cobryx.Domain.Entities.Accounting.LedgerAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Cobryx.Domain.Entities.Accounting.LedgerEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Cobryx.Domain.Entities.Accounting.LedgerOutbox", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("LedgerOutboxes");
                });

            modelBuilder.Entity("Cobryx.Domain.Entities.Accounting.LedgerTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Cobryx.Domain.Entities.Accounting.ReconciliationAudit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Cobryx.Domain.Entities.AdminActionAudit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Cobryx.Domain.Entities.Lending.FinancialStatusAudit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Cobryx.Domain.Entities.Payments.PaymentLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Cobryx.Domain.Entities.TenantGrowthMetrics", b =>
                {
                    b.Property<Guid>("TenantId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Cobryx.Domain.Entities.TenantInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Cobryx.Domain.Entities.TenantMRRHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Cobryx.Domain.Entities.Accounting.LedgerEntry", b =>
                {
                    b.HasOne("Cobryx.Domain.Entities.Accounting.LedgerTransaction", null)
                        .WithMany("Entries")
            ...
            modelBuilder.Entity("Cobryx.Domain.Entities.Tenant", b =>
                {
                    b.HasOne("Cobryx.Domain.Entities.TenantGrowthMetrics", "GrowthMetrics")
                        .WithMany()
            ...
            modelBuilder.Entity("Cobryx.Domain.Entities.TenantGrowthMetrics", b =>
                {
                    b.HasOne("Cobryx.Domain.Entities.Tenant", null)
                        .WithOne()
                        .HasForeignKey("Cobryx.Domain.Entities.TenantGrowthMetrics", "TenantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
